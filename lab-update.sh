...
#Update SSP Groups for W01. M01 will remain the same
ansible-playbook /vpodrepo/2026-labs/2670/lab-startup/tag-ssp-vms.yml | tee -a /lmchol/hol/labstartup.log >> /home/holuser/hol/labstartup.log 2>&1

...
#Create L7 Context Profiles

print('Creating L7 Application Context Profile {}'.format(cpl7displayname))
...
print('Creating L7 Application Context Profile {}'.format(cpl7displayname2))

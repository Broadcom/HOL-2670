...
class IdpsT0:
  ...
  def disable_idps(self):
    data = {'resource_type':'Infra', 'children':[{'resource_type':'ChildResourceReference', 'id':'{}'.format(self.t0id), 'target_type':'Tier0', 'children':[{'Tier0SecurityFeatures':{'resource_type':'Tier0SecurityFeatures', 'features':[{'feature':'IDPS', 'enable':'false'}, {'feature':'IDFW', 'enable':'false'}]}, 'resource_type':'ChildTier0SecurityFeatures'}]}]}
